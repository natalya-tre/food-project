...
function slider({
  ...
  const slides = document.querySelectorAll(slide),
    ...
    sliedesField = document.querySelector(field),
    width = window.getComputedStyle(slidesWrapper).width;

  let slideIndex = 1;
  let offset = 0;

  // version 2 (оборачиваем все слайды offer__clide в div class="offer__slider-inner")
...
function tabs(tabsSelector, tabsContentSelector, tabsParentSelectot, activeClass) {
  ...
  const tabs = document.querySelectorAll(tabsSelector),
    ...
    tabsParent = document.querySelector(tabsParentSelectot);
